...
public class CloudSimAlgorithm {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DatacenterModel datacenterModel1 = new DatacenterModel(0, "x86", "Linux", "Xen", 12.0, 0.06, 0.013, 0.02, 0.01);
			DatacenterModel datacenterModel2 = new DatacenterModel(1, "x86", "Linux", "Xen", 0.0, 0.09, 0.025, 0.032, 0.015);
			DatacenterModel datacenterModel3 = new DatacenterModel(2, "x86", "Linux", "Xen", 3.0, 0.04, 0.01, 0.01, 0.005);
			DatacenterModel datacenterModel4 = new DatacenterModel(3, "x86", "Linux", "Xen", 0, 0.05, 0.022, 0.024, 0.010);
			DatacenterModel datacenterModel5 = new DatacenterModel(4, "x86", "Linux", "Xen", 6.0, 0.07, 0.018, 0.029, 0.008);
			...
			population1.initializePopulation(numberOfVms, brokerId, numberOfDataCenters, datacenters, vmlist, datacenterModels, vmModels);
